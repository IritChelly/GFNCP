import numpy as np
from ncp_prob_computation import compute_prob
import torch
...
def histogram_for_data_perms(data_orig, dpmm, params, N = 20, perms = 100):
    ...
    css, probs, _ = dpmm.module.sample_for_kl_eval(data)  # css: [M, N]; probs: [M,], where M is the number of succeeded samples.
